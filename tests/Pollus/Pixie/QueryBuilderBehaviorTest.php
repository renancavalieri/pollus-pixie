...
use Pollus\Pixie\Event\EventArguments;
use Pollus\Pixie\QueryBuilder\JoinBuilder;
...
class QueryBuilderTest extends TestCase
{
    ...
    public function testLockForUpdateSqlite()
    {
        $result = $this->getLiveConnectionSqlite()
                ->table('people')
                ->lockForUpdate()
                ->find(3);
    ...
    public function testLockForUpdateMysqlWhereOrderBy()
    {
        $result = $this->getLiveConnection()
                ->table('people')
                ->lockForUpdate()
