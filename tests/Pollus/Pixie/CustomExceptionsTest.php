...
class CustomExceptionsTest extends TestCase
{
    ...
    /**
     * @return \Pollus\Pixie\QueryBuilder\QueryBuilderHandler
    ...
    public function testConnectionException()
    {
        ...
        try {
            (new \Pollus\Pixie\Connection('mysql', [
                'driver'    => 'mysql',
                'host'      => '0.2.3.4',
                'database'  => 'test',
                'username'  => 'test',
        ...
        try {
            (new \Pollus\Pixie\Connection('sqlite', [
                'driver'   => 'sqlite',
                'database' => '/d/c/f',
                'prefix'   => '', // Table prefix, optional
            ]))->connect();
    ...
    public function testFindOrFailShouldNotThrowException()
    {
