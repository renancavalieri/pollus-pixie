...
class QueryBuilderHandler
{
    ...
    /**
     * @var \Pollus\Pixie\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    {
        /**
         * @var $queryObject   \Pollus\Pixie\QueryBuilder\QueryObject
    ...
    public function transaction(\Closure $callback): Transaction
    {
         ...
         *
         * @var \Pollus\Pixie\QueryBuilder\Transaction $queryTransaction
         * @throws \Exception
         */
